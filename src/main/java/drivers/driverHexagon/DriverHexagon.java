...
public class DriverHexagon {
    public static void main(String[] args) {
        ...
        System.out.println("TEST HEXAGON, Tria la opció: ");
        printIntructions();
        ...
        System.out.println("Final de HEXAGON TEST");
    }
    ...
    private static void printIntructions() {
        ...
        System.out.print("1 - Inicialitzar taulell quadrat \n2 - Visualitzar Posicions dels nombres\n" +
